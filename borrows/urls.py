...
urlpatterns=[
  ...
  path('api/admin/all', views.get_admin_borrows_list, name='admin-borrows-list'), 
  ...
  path('api/delete/<int:id>', views.deleteBorrowWithId, name='cancel-borrow'), 
  path('api/cancel/<int:id>', views.cancelBorrowWithId, name='cancel-borrow'),
